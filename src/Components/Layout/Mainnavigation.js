...
import BookingCard from "../AllBooking/BookingsCard";
...
const Mainnavigation = (props) => {
  ...
  const isOpenBookings = useSelector((state) => state.ui.isOpenBookigs);
  ...
  const BookingCartOpen = () => {
    console.log("true");
    dispatch(UiActions.isBookingsCartOpen(true));
  };
